                                    ...
                                    <div class="col-lg-12">
                                             ...
                                             @method('PATCH')
                                                    <div class="input-group pb-3">
                                                        <select name="parent_id" value="{{ $category->id }}" class="custom-select text-uppercase" id="inputGroupSelect01">
                                                    ...
                                                    <div class="tab-content" id="pills-tabContent">
                                                        <div class="tab-pane fade show active" id="pills-home"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ $category->name_uz }}" name="name_uz" class="form-control" id="name_uz" >
                                                            </div>
                                                        ...
                                                        <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ $category->name_ru }}" name="name_ru" class="form-control" id="name_ru" >
                                                            </div>
